...
/**
 * Objeto é um conjunto de linhas.
 * @author Guilherme
 *
 */
 ...
 * não nós dar, temos que criar este adapter.
 */
...
class AdapterDemo {
	...
	private static void draw() {
		//Para cada retângulo, queremos saber quais os pontos que o formaram, chamando assim o adapter que criamos acima.
