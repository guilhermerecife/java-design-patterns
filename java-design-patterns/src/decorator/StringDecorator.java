...
/**
 *  É um padrão de projeto de software que permite adicionar um comportamento a um objeto já existente em tempo de execução
 *  , ou seja, agrega dinamicamente responsabilidades adicionais a um objeto.[1] Decorators oferecem uma alternativa
 *   flexível ao uso de herança para estender uma funcionalidade, com isso adiciona-se uma responsabilidade ao objeto e não à classe.
 * @author Guilherme
 *
 */
...
//Prcisamos adicionar um comportamento a String, fazemos isto implementando o decorator MagicString.
class MagicString {
	private String string;

	public MagicString(String string) {//Possui uma string para delegar os métodos que não irão sofrem alteração.
		this.string = string;
	}

	public long getNumberOfVowels() {//Método desejado.
